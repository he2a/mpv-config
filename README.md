...
## System Requirement
This config was made for my current PC setup with RTX 4070 and 1080p 165Hz SDR screen, but can be used with low end integrated GPU like Intel HD Graphics 620 with limited functionality. You can improve performance by changing the quality of video from High to Medium or Low in `Menu` `→` `Video` `→` `Quality`.
